...
print("🔥 [Project Phoenix V8] NaN 버그 완전 방어 및 UI 복구 중...")
...
<html lang="ko">
<head>
    <meta charset="UTF-8"><title>Phoenix PRO - AI Trading V8</title>
...
<body class="h-screen flex flex-col select-none">
    <header class="h-12 bg-panel border-b border-line flex justify-between items-center px-4 shrink-0">
        <div class="flex items-center space-x-6">
            <h1 class="text-lg font-bold text-white tracking-wider">UPBIT <span class="text-yellow-500 text-sm border border-yellow-500 px-1 rounded ml-1">AI PRO V8</span></h1>
...
html_part2 = """
    <main id="v-trd" class="flex-1 flex overflow-hidden p-1 space-x-1">
        ...
        <div class="w-[380px] flex flex-col bg-panel shrink-0">
            <div class="p-2 border-b border-line text-xs text-yellow-500 font-bold bg-[#1b2029]">💡 코인을 클릭하면 차트가 변경됩니다.</div>
        ...
        function renderAnalysis() {
            ...
            document.getElementById('ai-analysis-box').innerHTML = `
                <div class="bg-[#1b2029] p-3 rounded border border-gray-700 space-y-2">
                    ...
                    <div class="mt-2 text-gray-500 pt-2 border-t border-gray-800">※ 설정된 [${currentMode}] 모드에 따라 알고리즘 최적화 중.</div>
                </div>`;
        }
