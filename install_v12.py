...
print("🔥 [Project Phoenix V12] 커스텀 로고 및 AI 수익률 연동 중...")
...
# 4. Trader (AI 총 수익 및 수익률 계산 로직 추가)
...
class PhoenixTrader:
    ...
    async def get_portfolio_status(self):
        ...
        return {
            ...
            "ai_tot": float(tot_ai), "ai_prof": float(ai_prof), "ai_rate": float(ai_rate),
            "analysis": analysis_data, "daily_pnl": daily_pnl
        }
"""

# 5. HTML 파트 1 (커스텀 로고 적용 & 헤더 정보 변경)
    ...
    <header class="h-12 bg-panel border-b border-line flex justify-between items-center px-4 shrink-0">
        ...
        <div class="flex gap-5 items-center text-xs text-gray-400">
            <div class="flex items-center gap-2 bg-[#0b1016] px-3 py-1 rounded border border-gray-800">
                <span class="text-yellow-500 font-bold">🤖 AI 트레이딩 손익:</span> 
...
def install():
    ...
    for path, content in files.items():
        ...
        print(f"✅ V12 커스텀 마법 완료: {path}")
    print("\n🎉 모든 디자인 및 연동이 완료되었습니다! 브라우저를 확인하세요.")
