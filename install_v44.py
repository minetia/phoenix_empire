...
print("🔥 [Project Phoenix V43] 모바일 메뉴 잘림 복구 및 10단계 칭호 시스템 업데이트 중...")
...
# 2. Trader (V43: 10단계 진화 칭호 디테일 적용)
...
class PhoenixTrader:
    ...
    # [V43 핵심] 유저 피드백 기반 10단계 진화 칭호 (키워드 100% 매칭)
...
# HTML UI (V43: 모바일 상단 메뉴 가로 스크롤 잘림 완벽 해결)
html_ui = """<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <title>PHOENIX AI TRADING V43</title>
    ...
    <header class="py-3 lg:h-14 lg:py-0 bg-panel border-b border-line flex flex-col lg:flex-row justify-between items-center px-4 shrink-0 gap-3">
        <div class="flex flex-col lg:flex-row items-center w-full lg:w-auto gap-3 overflow-hidden">
            <div class="flex items-center cursor-pointer shrink-0" onclick="setTab('trd')">
                ...
                <span class="text-[10px] text-yellow-500 border border-yellow-500/50 bg-yellow-900/30 px-1.5 py-0.5 rounded ml-2 font-bold tracking-wide">V43</span>
            </div>
...
print("✅ V44 모바일 메뉴 스와이프 복구 및 10단계 AI 진화 시스템 적용 완료!")