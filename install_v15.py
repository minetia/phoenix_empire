...
print("🔥 [Project Phoenix V15] AI 코인별 상세 손익 DB 업그레이드 중...")
...
class PhoenixTrader:
    ...
    async def get_portfolio_status(self):
        ...
        res = []
        analysis_data = {}
        ai_coin_pnl = [] # [V15] AI 7개 코인별 상세 성과 데이터
        ...
        for c in self.port:
            ...
            # V14 호환성: 보유량은 있는데 평단가가 0이면 현재가로 보정
    ...
    <main id="v-pnl" class="flex-1 hidden bg-[#0b1016] p-4 overflow-y-auto w-full">
        <div class="max-w-[1200px] mx-auto mt-4">
            ...
            <div class="bg-panel rounded-lg p-6 mb-6 border border-gray-800 shadow-lg flex justify-between items-center">
                ...
                <div class="text-right"><p class="text-sm text-gray-400 mb-1">총 자산 (초기: 1억)</p><p id="ai-total-val" class="text-3xl font-bold num-font text-yellow-500">0 KRW</p></div>
            </div>
...
def install():
    ...
    for path, content in files.items():
        ...
        print(f"✅ V15 코인별 투자손익 패치 완료: {path}")
    print("\n🎉 모든 설치가 끝났습니다!")
